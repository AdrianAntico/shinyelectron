...
- [Electron ShinyApp Deployment by @ksasso][ksassoshinyappdev]
- [How to Make an R Shiny Electron App by @lawalter][shiny-electron-walter-tutorial]
- [R Shiny and Electron by @dirkschumacher][shiny-electron-dirk-tutorial]
- [Creating Standalone Shiny Apps with Electron on macOS M1][shiny-electron-zarathucorp-m1]
- [Creating Standalone Shiny Apps with Electron on Windows by @jhk0530][shiny-electron-zarathucorp-windows]
- [Creating Standalone Apps from Shiny with Electron (R-bloggers) by @jhk0530][shiny-electron-zarathucorp-rbloggers]
